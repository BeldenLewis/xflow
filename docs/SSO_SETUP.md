...
xflow 는 Supabase Auth 를 사용해서 Google OAuth 를 쉽게 추가할 수 있습니다.
...
## 3. xflow 로그인 페이지에 버튼 추가

`/Users/lynlea/xflow/src/app/(auth)/page.tsx` (또는 로그인 페이지) 에 추가:
...
`/Users/lynlea/xflow/src/app/auth/callback/route.ts` 가 이미 존재 — Supabase 가 자동으로 처리.
