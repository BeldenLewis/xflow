...
export default function GdprModal({ sourceId, onClose, onChanged }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4" onClick={onClose}>
      <div className="bg-background border border-border rounded-2xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-hidden flex flex-col" onClick={(e) => e.stopPropagation()} role="dialog" aria-label="개인정보 처리">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <button onClick={handleAnalyze} disabled={analyzing} className="px-3 py-2 rounded-xl bg-violet-500 text-white text-xs font-medium disabled:opacity-40">
            ...
            <div className="space-y-3">
              ...
              {result.matched > 0 && (
                <>
                  ...
                  <button onClick={handleDelete} disabled={deleting} className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-red-500 text-white text-sm font-medium hover:bg-red-600 disabled:opacity-40">
