...
function generateBannerHtml(
  ...
  return `<!-- xflow 웨비나 배너 (${webinar.slug}) -->
<style>
...
<script>
  ...
  var state={reg:JSON.parse(localStorage.getItem("xflow_reg_"+SLUG)||"null"),pingTimer:null,announceTimer:null,popupTimer:null,qaPolling:null,shownPopups:JSON.parse(localStorage.getItem("xflow_popups_"+SLUG)||"[]"),popupQueue:[],liveReady:false};
