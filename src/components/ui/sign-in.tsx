...
export const SignInPage: React.FC<SignInPageProps> = ({
  title = <span className="font-light text-foreground tracking-tighter">환영합니다</span>,
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              <div className="animate-element animate-delay-300">
                ...
                <GlassInputWrapper>
                  <input name="email" type="email" placeholder="이메일을 입력하세요" className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none" />
                </GlassInputWrapper>
              </div>
              ...
              <div className="animate-element animate-delay-400">
                ...
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="비밀번호를 입력하세요" className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none" />
